...
class Blog extends Component {
    ...
    getBlogItems() {
        ...
        axios.get(
            `https://mg.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`,
    ...
    handleDeleteClick(blog) {
        ...
        .catch(error => {
            console.log("error in blog deletion", error)
        })
    }
                ...
                return (
                    <div className="admin-blog-wrapper" key={blogItem.id}>
                        ...
                        <a onClick={() => this.handleDeleteClick(blogItem)}>
                            <FontAwesomeIcon className="blog-delete-icon" icon="trash" />
                        </a>
                    </div>
                )
            } else {
