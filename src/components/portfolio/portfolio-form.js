...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://mg.devcamp.space/portfolio/portfolio_items",
            apiAction: "post",

            //For edit mode use only
            added_thumb: false,
            added_banner: false,
            added_logo: false
        }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://mg.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
        ...
        axios({
            ...
            .then(response => {
                ...
                [this.thumbRef, this.bannerRef, this.logoRef].forEach(ref => {
                    ref ? ref.current.dropzone.removeAllFiles() : ""
                })
            })
            .catch(error => {
        ...
        return (
            <form onSubmit={this.handleSubmit} className="portfolio-form-wrapper">
                ...
                <div className={this.state.editMode? (
                    "btn-wrapper two-column"
                ) : "btn-wrapper one-column"}
                >
